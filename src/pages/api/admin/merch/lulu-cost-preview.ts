 ...
 *
 * Lets a store admin preview Lulu's print + Mail-shipping cost for a
 * format/page-count combo before setting a retail price — a single
 * print-job-cost-calculations call against a fixed reference address (no
 * real order, no real shipment).
 */
