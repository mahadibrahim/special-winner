  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        {/* Meta rows A-C — same mt-2/mt-1/mt-1 rhythm as CardBody. h-3.5
            matches the text-xs line box the live rows occupy; the previous
            h-3 bars ran a few px short of the real rows (#462). */}
        <div className="flex items-center gap-1.5 mt-2">
          <div className="h-3.5 w-3/4 rounded bg-border/30 animate-pulse" />
        </div>
        <div className="flex items-center gap-1.5 mt-1">
          <div className="h-3.5 w-1/2 rounded bg-border/30 animate-pulse" />
        </div>
        <div className="flex items-center gap-1.5 mt-1">
          <div className="h-3.5 w-2/3 rounded bg-border/30 animate-pulse" />
        </div>
        ...
        {/* Price band + CTA band. The price side mirrors the two-line shape
            live cards render (amount + the small unit line under it, e.g.
            "per kid") — the single-bar shimmer only matched one-price cards
            (#462). */}
        <div className="pt-3 border-t border-border flex items-end justify-between">
          <div className="flex flex-col gap-1">
            ...
            <div className="h-2.5 w-10 rounded bg-border/30 animate-pulse" />
          </div>
