    ...
    <div className="rounded-2xl bg-amber-50 border border-amber-200 p-4">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-semibold text-amber-900">Verify your email address</h3>
          <p className="text-sm text-amber-800 mt-1">
            We sent a verification link to <span className="font-medium text-amber-900">{email}</span>.
          ...
          <div className="flex items-center gap-3 mt-3">
            ...
            {resendStatus === "error" && (
              <span className="text-sm text-red-700">Failed to send. Try again.</span>
            )}
          </div>
        </div>
