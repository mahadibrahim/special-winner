              ...
              {isSubscribed ? (
                ...
                <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg text-sm font-medium transition-all hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
                  >
                    {isSubmitting ? (
