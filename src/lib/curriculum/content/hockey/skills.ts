...
//
// Transcribed verbatim (byte-for-byte, via a scratch tsx extraction script --
// see the Task 6 report at .superpowers/sdd/cr-task-6-report.md for method)
// from the recovered curriculum seed `.superpowers/curriculum-recovery/seeds/
// curriculum-v2__hockey-skills.ts` (REFERENCE ONLY -- never imported from
// src/). All 13 skills, 5 technical / 3 tactical / 2 physical / 3
// psychological, all at the "fundamentals" stage per the source. There is no
// hockey upgrade file and no gen-0 hockey rows in
// `src/lib/db/seed-curriculum.ts` (that file only seeds soccer and
// basketball) -- so this is a single-pass transcription, no fold needed.

import type { SkillContent } from "../types";

export const HOCKEY_SKILLS: SkillContent[] = [
  {
    sport: "hockey",
    domain: "technical",
    stage: "fundamentals",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "4": {
          ...
          commonMistakes: ["May coast in games", "Could be more explosive"],
          coachingTips: [
        ...
        "5": {
          ...
          commonMistakes: ["May rely too heavily on skating"],
          coachingTips: [
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["May over-rely on skating"],
          coachingTips: [
            "Continue challenging",
            "Leadership role",
            "Help others develop",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["May try too much"],
          coachingTips: [
            "Continue challenging",
            "Leadership role",
            "Help others develop",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["May expect too much from teammates"],
          coachingTips: [
            "Continue challenging",
            "Leadership role",
            "Help others develop",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["May over-rely on shot"],
          coachingTips: [
            "Continue challenging",
            "Maintain sharpness",
            "Help others develop",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["May be targeted with speed"],
          coachingTips: [
            "Continue challenging",
            "Defensive leadership",
            "Help others develop",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["May leave teammates behind"],
          coachingTips: [
            "Continue developing",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "4": {
          ...
          commonMistakes: ["Could always improve", "Fatigue affects edges"],
          coachingTips: [
            "Maintain through season",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "4": {
          ...
          commonMistakes: ["May over-rely on speed", "Could pace better"],
          coachingTips: [
            "Maintain through season",
            "Speed endurance",
            "Tactical speed use",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "4": {
          ...
          commonMistakes: ["May become over-confident", "Could take bad risks"],
          coachingTips: [
        ...
        "5": {
          ...
          commonMistakes: ["May border on arrogance"],
          coachingTips: [
            "Leadership development",
            "Help others grow",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "5": {
          ...
          commonMistakes: ["Teammates may not keep up"],
          coachingTips: [
            "Continue challenging",
            "Leadership development",
            "Teaching others",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        "4": {
          ...
          commonMistakes: ["May take bad penalties", "Could channel better"],
          coachingTips: [
        ...
        "5": {
          ...
          commonMistakes: ["May be too intense at times"],
          coachingTips: [
            "Channel appropriately",
            "Leadership in compete",
            "Help others develop",
