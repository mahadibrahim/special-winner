...
//   entries).
//
// Net count: 33 basketball skills (13 v2-canonical + 13 gen-0-shelled + 7
// brand new). The 13-skill / 5-3-2-3 split is preserved as the v2 floor
// (scoped to the 13 v2-canonical names); this file's actual totals are
// asserted directly in registry.test.ts.
...
export const BASKETBALL_SKILLS: SkillContent[] = [
  ...
  },
  {
    ...
    description:
      "Controlling the ball while standing still (pounds, wraps, figure 8)",
    introductionAge: 6,
    assessmentMethod: "observation",
    isCore: true,
    sortOrder: 1,
    ...
    comprehensiveGuide: {
      ...
      assessmentFrequency:
        "Every 2-3 weeks observation, formal assessment monthly",
      assessmentDuration:
        "30-60 seconds of focused observation per assessment activity",
    },
  },
  {
    sport: "basketball",
    ...
    comprehensiveGuide: {
      levelDetails: {
        1: {
          name: "Emerging",
          description:
            "Pass lacks power and direction. Incorrect hand position and ball floats or bounces unpredictably.",
          observableBehaviors: [
        ...
        2: {
          name: "Developing",
          description:
            "Can make short chest passes to stationary target. Form developing but inconsistent.",
          observableBehaviors: [
        ...
        3: {
          name: "Competent",
          description:
            "Accurate chest passes at medium distance. Proper thumbs-down follow-through and can hit moving target.",
          observableBehaviors: [
        ...
        4: {
          name: "Proficient",
          description:
            "Crisp, accurate passes in game situations. Good vision and decision-making.",
          observableBehaviors: [
            "Accurate in games",
            "Good pass fakes",
            "Reads defenders",
        ...
        5: {
          name: "Advanced",
          description:
            "Elite passer with exceptional vision. Creates scoring opportunities for teammates.",
          observableBehaviors: [
            "Sees passing lanes others miss",
            "Perfect weight on every pass",
      ...
      parentExplanation:
        "The chest pass is basketball's fundamental pass - it's how players share the ball effectively. We teach 'step and push' with thumbs ending down. Passing is about teamwork and communication. At home, playing catch with any ball develops passing skills. Ask your child to show you the 'thumbs down' follow-through - they love teaching what they've learned!",
      homeActivities: [
      ...
      assessmentFrequency:
        "Every 2-3 weeks observation, formal assessment monthly",
      assessmentDuration:
        "Observe grip, step, and follow-through mechanics. Note accuracy to stationary and moving targets.",
    },
  },
  {
    sport: "basketball",
    ...
    comprehensiveGuide: {
      levelDetails: {
        1: {
          name: "Emerging",
          description:
            "Cannot coordinate running, jumping, and shooting. Wrong foot/hand combination, ball rarely reaches rim.",
          observableBehaviors: [
            "Same foot/same hand takeoff",
        ...
        2: {
          name: "Developing",
          description:
            "Developing footwork with occasional correct takeoff. Makes some layups from close range.",
          observableBehaviors: [
            "Sometimes correct footwork",
        ...
        3: {
          name: "Competent",
          description:
            "Consistent footwork and technique. Uses backboard effectively, makes 50%+ from short approach.",
          observableBehaviors: [
            "Footwork automatic",
            "Effective backboard use",
            "Makes 5+ of 10",
        ...
        4: {
          name: "Proficient",
          description:
            "Smooth layups from various angles. Good finish touch even with defense present.",
          observableBehaviors: [
            "Makes 7+ of 10 in drills",
            "Finishes with either hand",
            "Adapts to defense",
        ...
        5: {
          name: "Advanced",
          description:
            "Elite finisher making layups through contact. Creative finishes, truly ambidextrous.",
          observableBehaviors: [
      ...
      assessmentFrequency:
        "Weekly observation during drills, formal assessment monthly",
      assessmentDuration:
        "Assess footwork legality first, then finish touch. Compare dominant and weak side.",
    },
  },
  {
    sport: "basketball",
    ...
    comprehensiveGuide: {
      levelDetails: {
        1: {
          name: "Emerging",
          description:
            "Cannot stop from dribble into jump shot. Travels, loses balance, or has no shooting form.",
          observableBehaviors: [
            "Travels on stop",
        ...
        2: {
          name: "Developing",
          description:
            "Beginning to coordinate stop and shot. Footwork developing, shot consistency limited.",
          observableBehaviors: [
        ...
        3: {
          name: "Competent",
          description:
            "Proper footwork and reasonable form. Makes open pull-ups from mid-range.",
          observableBehaviors: [
            "Legal footwork consistently",
            "Proper gather and jump",
            "Balanced at release",
        ...
        4: {
          name: "Proficient",
          description:
            "Effective pull-up from various spots. Creates this shot against defenders.",
          observableBehaviors: [
        ...
        5: {
          name: "Advanced",
          description:
            "Elite pull-up shooter. Scores from anywhere against any defense.",
          observableBehaviors: [
            "Makes 50%+ mid-range",
            "Unguardable release",
      ...
      parentExplanation:
        "The pull-up jumper is stopping from a dribble to shoot - crucial because defenders can't block it easily. We teach proper footwork, gathering the ball while stopping, and shooting with the same form as a set shot. At home, your child can practice the footwork and stop without a basket. This is advanced - mastering dribbling and shooting separately comes first!",
      homeActivities: [
      ...
      assessmentDuration:
        "Assess footwork, balance, and form separately before evaluating makes.",
    },
  },
  {
    sport: "basketball",
    ...
    comprehensiveGuide: {
      levelDetails: {
        1: {
          name: "Emerging",
          description:
            "Player throws ball at basket without consistent form. Two-handed push, no arc, minimal control over where ball goes.",
          observableBehaviors: [
        ...
        2: {
          name: "Developing",
          description:
            "Developing one-hand shooting motion. Some BEEF elements present but inconsistent. Makes occasional close shots.",
          observableBehaviors: [
            "Attempting one-hand release",
        ...
        3: {
          name: "Competent",
          description:
            "Proper BEEF form (Balance, Eyes, Elbow, Follow-through) is consistent. Good arc and 40%+ from close range.",
          observableBehaviors: [
        ...
        4: {
          name: "Proficient",
          description:
            "Smooth, consistent form from various distances. High percentage from mid-range. Form maintained under pressure.",
          observableBehaviors: [
        ...
        5: {
          name: "Advanced",
          description:
            "Textbook shooting form with high percentage. Maintains form in all situations. Team's reliable scorer.",
          observableBehaviors: [
            "Near-perfect form every shot",
            "High percentage shooter",
            "Clutch in big moments",
      ...
      parentExplanation:
        "Shooting form is about building proper mechanics - BEEF stands for Balance, Eyes on target, Elbow under ball, Follow-through. This takes thousands of repetitions to develop into muscle memory. At home, focus praise on effort and form, not whether shots go in. A great follow-through with a miss is better than a made shot with poor form! Use lower baskets for young players to develop proper mechanics without straining.",
      homeActivities: [
      ...
      assessmentFrequency:
        "Weekly observation during shooting drills, formal assessment monthly",
      assessmentDuration:
        "Prioritize form evaluation over make percentage. Observe across multiple shots and distances.",
    },
  },
  {
    sport: "basketball",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        5: {
          ...
          commonMistakes: ["May get frustrated when others don't space well"],
          coachingTips: [
      ...
      assessmentFrequency:
        "Every scrimmage/game observation, formal assessment monthly",
    ...
    comprehensiveGuide: {
      levelDetails: {
        1: {
          name: "Emerging",
          description:
            "Clusters with ball and teammates. No awareness of court space, follows ball like a magnet.",
          observableBehaviors: [
        ...
        2: {
          name: "Developing",
          description:
            "Beginning to understand spacing. Can space when reminded but drifts back to ball.",
          observableBehaviors: [
            "Understands concept when explained",
        ...
        3: {
          name: "Competent",
          description:
            "Maintains appropriate spacing in drills. Understands 12-15 foot rule, self-corrects.",
          observableBehaviors: [
            "Maintains spacing in drills",
            "Self-corrects when too close",
            "Moves when ball moves",
        ...
        4: {
          name: "Proficient",
          description:
            "Good court awareness, finds space consistently. Creates offensive opportunities.",
          observableBehaviors: [
            "Consistent game spacing",
            "Reads and reacts to defense",
            "Creates advantages through position",
        ...
        5: {
          name: "Advanced",
          description:
            "Elite spacing intelligence. Creates advantages for self and teammates through positioning.",
          observableBehaviors: [
            "Elite court vision",
            "Manipulates defense with position",
            "Creates opportunities constantly",
      ...
      assessmentDuration:
        "Observe positioning throughout possessions, not just at start. Note self-correction.",
    },
  },
  {
    sport: "basketball",
