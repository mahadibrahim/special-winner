...
export const SOCCER_ACTIVITIES: ActivityContent[] = [
  ...
  },
  {
    ...
    diagram:
      "S1 ▲ ▲ ▲ ▲      S2 ▲ ▲ ▲ ▲\n○● ○● ○●        ○● ○● ○●\n\nS3 ▲ ▲ ▲ ▲      S4 ▲ ▲ ▲ ▲\n○● ○● ○●        ○● ○● ○●\n\nS1-S4=move stations (cone lines)\n▲=cone ○●=player with ball",
    coachingPoints: [
    ...
    comprehensiveGuide: {
      ...
      developmentalContext: {
        ...
        ageAdaptations: {
          ...
          ages9to11: {
            approach:
              "US Soccer policy does not permit heading practice for players age 10 and under - only balloon/very-light-ball familiarization is appropriate at that age, exactly like the ages6to8 guidance. For 9-10 year-olds, run this activity with a balloon or very light foam ball only, no real-ball contact, framed entirely as a preview of a skill they'll learn later. Real headers wait until age 11. Age 11 is when the actual progression begins - move through the seated, kneeling, and standing stages carefully and patiently with a real, appropriately sized ball. Most 11-year-old groups should stay at or below the standing stage; only progress to jump-and-head for players who are clearly ready and have shown clean technique repeatedly.",
            keyPhrases: [
              "Ages 9-10: 'You'll learn real heading at 11 - let's practice with the balloon!'",
              "Age 11: 'Forehead, eyes open, firm neck - every single time!'",
              "Age 11: 'We earn the next stage by showing clean technique!'",
              "No rush - this is about doing it right!",
            ],
            avoidSaying: [
              "Head it hard",
              "Everyone heads a real ball today (ages 9-10 stay balloon-only, no exceptions)",
            ],
            challenges: [
              "Ages 9-10: balloon-only forehead familiarization, no real ball contact",
              "Age 11: standing headers with consistent technique",
              "Age 11: jump-and-head only for clearly ready players",
            ],
            duration:
              "Ages 9-10: 3-5 minutes, Balloon Warm-Up only. Age 11: 8-10 minutes with a real ball.",
          },
          ages12to14: {
            approach:
      ...
      safety: {
        commonRisks: [
          ...
          {
            risk: "Excess cumulative heading volume across a season increasing injury risk for developing players",
            prevention:
              "Follow US Soccer's limited-heading guidance: no real-ball heading for ages 10 and under, and no more than 30 minutes of heading practice per week for ages 11-13, spread across sessions rather than one block",
            response: "Trim or skip heading work for the rest of the week if the weekly volume guidance has already been met",
          },
          {
  ...
  },
  {
    ...
    diagram:
      "         ┌──────┐\n         │ GOAL │\n         └──────┘\nS1▲●                    S4▲●\n ○○      S2▲●    S3▲●    ○○\n          ○○      ○○\nstations arc around the goal;\ngroups rotate S1→S2→S3→S4\n▲=cone ●=balls ○=players",
    coachingPoints: [
  ...
  },
  {
    ...
    diagram:
      "S1 give-and-go    S2 overlap\n▲     ▲           ▲     ▲\n○○○●              ○○○●\n      ▲                 ▲\n\nS3 third-man run\n▲     ▲     ▲\n○○○○●\n\nS1-S3=pattern stations\n▲=cone ○=player ●=ball",
    coachingPoints: [
  ...
  },
  {
    ...
    diagram:
      "┌────────────────────────────┐\n│   ○     ○●    ○     ○      │\n│        ●D                  │\n│     ○      ○      ○        │\n│          ●D    ●D          │\n│      ○     ○      ○        │\n└────────────────────────────┘\n         30x25 paces\n4-3-3 shape; defenders hold\nthe zones they would occupy\n○=attacker ●=ball ●D=defender",
    coachingPoints: [
  ...
  },
  {
    ...
    diagram:
      "     ┌────┐\n     │GOAL│\n┌────┴────┴────────┐\n│ ○A ● ○A  ○A   ○B │\n├──────────────────┤\n│  ○A   ○B  ○A  ○B │\n├──────────────────┤\n│ ○B   ○B  ○B   ○A │\n└────┬────┬────────┘\n     │GOAL│\n     └────┘\n    30x40 paces\nthirds; players stay in zone\n○A=team A ○B=team B ●=ball GOAL=goal",
    coachingPoints: [
  ...
  },
  {
    ...
    setupInstructions:
      "EQUIPMENT CHECKLIST\n□ 4 corner cones\n□ Pinnies, 2 colors\n□ 3-4 balls (games restart often early on)\n\nSPACE: 25x20 paces\n\nSETUP STEPS\n1. Mark a 25x20 pace rectangle with a cone at each corner\n2. The two short 20-pace ends are the scoring lines - no goals needed\n3. Split into two teams of 3, different colored pinnies\n4. Each team defends one end line and attacks the other\n5. Start the ball in the center with a coach roll-in\n6. With more than 6 players (up to 12), either run two separate 25x20 grids side by side so every group of 6 gets a 3v3 (best for 9-12 players), or keep one grid and have the extra trio wait on the sideline as substitutes who rotate in for a full team every few minutes or after each goal (best for 7-8 players)\n\nDIAGRAM\n A scores over this line\n┌────────────────────────┐\n│▲                      ▲│\n│    ○B   ○B   ○B        │\n│                        │\n│           ●            │ 25\n│                        │ paces\n│    ○A   ○A   ○A        │\n│▲                      ▲│\n└────────────────────────┘\n B scores over this line\n ends = 20-pace scoring lines\n▲=cone ○=player(A/B) ●=ball",
    howToPlay:
  ...
  },
  {
    ...
    skillsDeveloped: ["finding-space", "passing-short"],
    setupInstructions:
      "EQUIPMENT CHECKLIST\n□ 6 mini goals (3 per team) or 12 cones\n□ Pinnies, 2 colors\n□ 3-4 balls\n\nSPACE: 35x25 paces\n\nSETUP STEPS\n1. Mark a 35x25 pace field\n2. Place 3 small goals along each end line - one center, two in the corners\n3. Split into two teams of 4-5, different colored pinnies\n4. Corner goals are worth 2 points, the center goal is worth 1\n5. Kickoff from the center\n6. With 11-14 players, either split into three teams of 4-5 and rotate one team off the field on a timer (winners stay on, next team rotates in every few minutes), or widen the field to 40x28 paces and run larger teams of 5-7 per side with a second set of goals so there's still room to switch the point of attack\n\nDIAGRAM\n ⊏⊐      ⊏⊐      ⊏⊐  B goals\n  ○B   ○B    ○B   ○B\n           ●          25 paces\n  ○A   ○A    ○A   ○A\n ⊏⊐      ⊏⊐      ⊏⊐  A goals\n       35 paces\ncorner goals 2pts, middle 1pt\n⊏⊐=mini goal ○=player ●=ball",
    howToPlay:
          ...
          after: [
            {
              activity: "World Cup",
              reason:
                "Moves shooting technique into a live, game-realistic scoring environment - specifically the everyone-for-themselves, multi-ball, central-goal format (not the single-goalkeeper 'World Cup' variant), which matches Soccer Bowling's beginner/fundamentals-through-skill-building level and its focus on repeated, low-pressure shooting reps",
            },
            {
              activity: "Crossing and Finishing",
