...
//
// Net count: 34 soccer skills (13 canonical + 13 gen-0-shelled + 8 brand
// new). The 13-skill / 5-3-2-3 split is preserved as the v2 floor; this
// file's actual totals are asserted directly in registry.test.ts.
...
export const SOCCER_SKILLS: SkillContent[] = [
  ...
  {
    slug: "inside-of-foot-pass",
    name: "Inside of Foot Pass",
    sport: "soccer",
    domain: "technical",
    stage: "fundamentals",
    description:
      "Passing the ball using the inside of the foot to a stationary partner",
    introductionAge: 6,
    assessmentMethod: "observation",
    progressionLevels: {
    ...
    comprehensiveGuide: {
      ...
      assessmentFrequency: "Weekly observation, formal assessment monthly",
      assessmentDuration:
        "Observe across multiple passing situations (5-10 minutes)",
    },
  },
  {
  ...
  {
    slug: "receiving-with-inside-of-foot",
    name: "Receiving with Inside of Foot",
    sport: "soccer",
    domain: "technical",
    stage: "fundamentals",
    description:
      "Stopping/controlling a rolling ball with the inside of the foot",
    introductionAge: 6,
    assessmentMethod: "observation",
    progressionLevels: {
    ...
    comprehensiveGuide: {
      ...
      assessmentFrequency: "Weekly observation, formal assessment monthly",
      assessmentDuration:
        "Observe across multiple receiving situations (5-10 minutes)",
    },
  },
  {
    slug: "shooting-with-laces",
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        5: {
          ...
          commonMistakes: ["May become selfish for goals occasionally"],
          coachingTips: [
      ...
      assessmentFrequency: "Weekly observation, formal assessment monthly",
      assessmentDuration:
        "Observe across multiple shooting opportunities (5-10 minutes)",
    },
  },
  {
  ...
  },
  {
    ...
    comprehensiveGuide: {
      ...
      assessmentFrequency:
        "Weekly observation during training, formal assessment monthly",
      assessmentDuration:
        "Observe across multiple 1v1 opportunities in training and games (10-15 minutes)",
    },
  },
  {
    ...
    comprehensiveGuide: {
      levelDetails: {
        ...
        5: {
          ...
          commonMistakes: ["Teammates may over-rely on their defending"],
          coachingTips: [
      ...
      assessmentFrequency:
        "Weekly observation during training, formal assessment monthly",
      assessmentDuration:
        "Observe across multiple 1v1 defensive situations (10-15 minutes)",
    },
  },
  {
    slug: "agility",
    ...
    comprehensiveGuide: {
      ...
      assessmentFrequency:
        "Weekly observation during training, formal assessment quarterly",
      assessmentDuration:
        "Observe across multiple training sessions and games (ongoing)",
    },
  },
  {
