/**
 * Baseball Skills Upgrade - Comprehensive Assessment Guides
 *
 * This seed file UPDATES existing baseball skills with comprehensive assessment guides.
 * Each skill is upgraded with:
 * - Detailed 5-level progression definitions
 * - Observable behaviors at each level
 * - Common mistakes and corrections
 * - Age-appropriate expectations with arm care guidelines
 * - Red flags for mechanical issues and overuse
 * - Parent communication templates
 * - Home activities for skill development (emphasizing arm care)
 *
 * Skills upgraded:
 * TECHNICAL: Throwing Mechanics
 *
 * Guidelines followed:
 ...
 * - Incorporates arm care research from Little League, MLB Pitch Smart, and ASMI
...
// Skill IDs to update
const SKILL_IDS = {
  throwingMechanics: "3b59056c-9f4b-4481-887d-2949af718485",
} as const;

export async function upgradeBaseballSkills() {
  console.log("Upgrading baseball skills with comprehensive assessment guides...");
  ...
  await db
    ...
    .set({
      ...
      tags: ["core", "technical", "fundamental", "throwing", "arm-action", "mechanics", "arm-care"],
      comprehensiveGuide: {
        levelDetails: {
          1: {
            name: "Emerging",
            description: "Player is learning the fundamental concept of throwing. Movements are segmented and ball is pushed rather than thrown with proper mechanics. Accuracy is inconsistent and arm action is developing.",
            observableBehaviors: [
          ...
          2: {
            name: "Developing",
            description: "Player is beginning to incorporate body rotation and proper arm path. Some throws show correct mechanics, but consistency varies. Starting to understand the kinetic chain concept.",
            observableBehaviors: [
          ...
          3: {
            name: "Competent",
            description: "Player demonstrates consistent arm action with proper elbow height and hip rotation. Throws are accurate at medium distances and mechanics hold up in most practice situations.",
            observableBehaviors: [
          ...
          4: {
            name: "Proficient",
            description: "Player exhibits fluid mechanics with full kinetic chain engagement. Throws are consistently accurate with good velocity. Has internalized arm care habits and can adjust mechanics for different throwing situations.",
            observableBehaviors: [
          ...
          5: {
            name: "Advanced",
            description: "Player has elite throwing mechanics optimized for their position. Exceptional accuracy and arm strength combined with deep understanding of mechanics and arm care. Serves as a model for younger players.",
            observableBehaviors: [
        ...
        assessmentFrequency: "Informal observation every practice during catch play. Formal mechanical assessment monthly. Arm care check-in at every session.",
        assessmentDuration: "5-10 minutes for catch play observation, 5-7 minutes for target throwing, 10-15 minutes for game situation assessment",
      },
      updatedAt: new Date(),
    })
    .where(eq(skills.id, SKILL_IDS.throwingMechanics));

  console.log("Successfully upgraded 1 baseball skill with comprehensive assessment guide!");
}

// Export for use in seed runner
export { upgradeBaseballSkills as default };
