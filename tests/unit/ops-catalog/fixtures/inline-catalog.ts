...
const actRainout: Activity = {
  ...
  tools: ["Cones and directional signage", "Weather app or National Weather Service radar"],
...
const actFieldSetup: Activity = {
  ...
  tools: ["Cones and directional signage", "The day's staffing plan (/admin/venue/day/[date])"],
