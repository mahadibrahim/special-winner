/**
 * Netlify Scheduled Function — triggers the field-rental pending-payment expiry
 * sweep every 5 minutes by POSTing to the /api/cron/expire-pending-rentals
 * route.
 *
...
export const handler = schedule("3-58/5 * * * *", async () => {
